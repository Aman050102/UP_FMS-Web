  ...
  return (
    <div className="min-h-screen bg-[#e6e0e0] flex items-center justify-center p-6 font-kanit text-[#1e293b]">
      <div className="w-full max-w-[500px] bg-white rounded-[28px] p-10 md:p-12 text-center shadow-2xl">
        <div className="mb-6">
          <img src={dsaLogo} className="h-[120px] mx-auto object-contain" />
        </div>
        <div className="space-y-1 mb-8">
          <h1 className="text-2xl font-bold text-[#2b2346]">
            ระบบจัดการข้อมูลสนามกีฬา
          </h1>
          <p className="text-sm text-[#756f8a]">
        ...
        <form className="space-y-6 text-left" onSubmit={onSubmitLogin}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 rounded-full text-white font-bold bg-gradient-to-r from-[#06b6d4] to-[#ec4899] shadow-lg flex items-center justify-center gap-2 disabled:opacity-50 transition-all"
          >
