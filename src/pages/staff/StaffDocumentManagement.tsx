        ...
        <section className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                type="month"
                className="p-2 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-primary/20"
              />
            </div>
          </div>
        </section>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-white text-gray-600 border-b border-gray-200 uppercase tracking-tighter">
                  <th className="px-4 py-4 font-bold text-center border-r border-gray-100 w-16">
                    ลำดับ
                  </th>
                  <th className="px-4 py-4 font-bold text-left border-r border-gray-100">
                    รหัสเอกสาร
                  </th>
                  <th className="px-4 py-4 font-bold text-left border-r border-gray-100">
                    รอบเดือน/ปี
                  ...
                  <th className="px-4 py-4 font-bold text-left border-r border-gray-100">
                    ชื่อรายงาน (ดึงข้อมูลอัตโนมัติ)
                  </th>
                  <th className="px-4 py-4 font-bold text-left border-r border-gray-100">
                    แหล่งข้อมูล
                  </th>
                  <th className="px-4 py-4 font-bold text-center border-r border-gray-100">
                    ความครบถ้วน
                  </th>
                  <th className="px-4 py-4 font-bold text-center">
                    พิมพ์รายงาน (PDF/Excel)
                  </th>
                </tr>
              </thead>
                ...
                {[
                  {
                    ...
                    code: "REP-FAC-6901",
                    period: "มกราคม 2569",
                    title: "สรุปสถิติจำนวนผู้เข้าใช้สนามกีฬาทุกประเภท",
                  ...
                  },
                  {
                    ...
                    code: "REP-EQP-6901",
                    period: "มกราคม 2569",
                    title: "รายงานการยืม-คืนอุปกรณ์กีฬาและวัสดุคงคลัง",
                    source: "บันทึกยืม-คืน",
                    completion: "100%",
                  },
                  {
                    id: 3,
                    code: "REP-FAC-6812",
                    period: "ธันวาคม 2568",
                    title: "สรุปยอดผู้เข้าใช้สนามประจำเดือน (ย้อนหลัง)",
                    source: "บันทึกเข้าสนาม",
                    completion: "100%",
                  },
                ].map((row) => (
                  ...
                  >
                    <td className="px-4 py-5 text-center text-gray-400 border-r border-gray-50">
                      {row.id}
                    </td>
                    <td className="px-4 py-5 font-mono text-xs text-gray-500 border-r border-gray-50">
                      {row.code}
                    </td>
                    <td className="px-4 py-5 font-bold text-gray-700 border-r border-gray-50">
                      {row.period}
                    </td>
                    <td className="px-4 py-5 font-bold text-primary border-r border-gray-50">
                      {row.title}
                    </td>
                    <td className="px-4 py-5 border-r border-gray-50">
                      <span className="flex items-center gap-1.5 text-xs text-gray-500 font-medium">
                        {row.source === "บันทึกเข้าสนาม" ? (
                          <BarChart3 size={14} />
                        ) : (
                          <History size={14} />
                        )}
