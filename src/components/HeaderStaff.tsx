    ...
    <header className="fixed top-0 left-0 right-0 h-header bg-surface flex items-center justify-between px-4 z-50 shadow-sm border-b border-border-main">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            className={`p-2.5 rounded-full transition-all cursor-pointer relative ${showNotify ? "bg-primary-soft text-primary" : "hover:bg-bg-main text-text-main"}`}
            onClick={() => {
          ...
          {showNotify && (
            <div className="absolute top-[55px] right-0 w-[320px] bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden animate-in fade-in slide-in-from-top-2 z-[3000]">
              <div className="p-4 border-b border-gray-50 font-bold text-sm text-text-main flex justify-between items-center bg-bg-main/30">
                คำขอสมัครสมาชิก{" "}
                <span className="text-primary bg-primary-soft px-2 py-0.5 rounded-full text-xs">
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between mt-1">
                          ...
                          <button
                            className="text-[11px] bg-primary text-white px-3 py-1 rounded-lg font-bold hover:opacity-90 transition-opacity"
                            onClick={() => navigate("/staff/menu")}
                          >
                            จัดการ
                          </button>
          ...
          {showProfile && (
            <div className="absolute top-[55px] right-0 w-[320px] bg-[#f0f3f8] rounded-[28px] shadow-2xl p-4 z-[3000] animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-xs text-primary font-bold bg-primary-soft inline-block px-3 py-1 rounded-full mt-1">
                  Staff Administrator
                </p>
              </div>
              <div className="space-y-2">
                <button
                  className="w-full bg-white hover:bg-gray-50 transition-colors p-3.5 rounded-2xl flex items-center justify-center gap-2 text-sm font-bold text-[#475569] border border-gray-100 cursor-pointer shadow-sm"
